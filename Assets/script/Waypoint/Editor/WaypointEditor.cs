...
public class WaypointEditor : Editor
{
    ...
    private void OnSceneGUI()
    {
        ...
        {         
            ...
            var fmh_20_85_638622600260536811 = Quaternion.identity; Vector3 newwaypointPoint = Handles.FreeMoveHandle(currentWaypointPoint, 0.7f, new Vector3(0.3f, 0.3f, 0.3f), Handles.SphereHandleCap);
